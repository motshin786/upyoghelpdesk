...
if(empty($this->aof_options['login_form_align_type']) || $this->aof_options['login_form_align_type'] == 1) {
  ...
  $css_styles .= '.wps-login-container { height: 100%; display:flex;justify-content: center;align-items: center;}';
}
else {
...
.login label, .login form, .login form p { color: ' . $this->aof_options['form_text_color'] . ' !important; text-align:left }
