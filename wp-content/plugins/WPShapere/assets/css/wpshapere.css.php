...
if(isset($this->aof_options['enable_menu_user_info']) &&  $this->aof_options['enable_menu_user_info'] == 1) {
  $css_styles .= '
    ...
    .wps-user-avatar img{border-radius: 100px;
    -moz-border-radius: 100px;
    -webkit-border-radius: 100px;
    -webkit-box-shadow: inset 0px 0px 9px 0px rgba(0,0,0,0.59);
-moz-box-shadow: inset 0px 0px 9px 0px rgba(0,0,0,0.59);
box-shadow: inset 0px 0px 9px 0px rgba(0,0,0,0.59);
  }
...
.import-php .updating-message:before, .update-message p:before, .updating-message p:before{color:' . $this->aof_options['sec_button_text_color'] . '}';
$css_styles .= '.wp-core-ui .button-secondary:focus, .wp-core-ui .button-secondary:hover, .wp-core-ui .button.focus,
.wp-core-ui .button.hover, .update-now:hover:before, .wp-core-ui .button:focus, .wp-core-ui .button:hover, #loco-admin.wrap .button:hover, #loco-admin.wrap .button-link:hover {
...
.wp-core-ui .button.hover .dashicons-plus:before, .wp-core-ui .button:focus .dashicons-plus:before, .wp-core-ui .button:hover .dashicons-plus:before {
    color: '. $this->aof_options['sec_button_hover_text_color'] . '!important}';
...
if($this->aof_options['design_type'] == 4) {
  ...
  .wrap .page-title-action:before, .wrap .page-title-action:active:before {
    position: absolute; left: 8px; top: 14px; content: "\f132"; font-family: dashicons; display: inline-block; line-height: 1; font-size: 14px; font-weight: 400;     font-style: normal; text-rendering: auto; -webkit-font-smoothing: antialiased;
  }
  ...
  //hide extra admin bar menu items for small screens
  $css_styles .= '@media screen and (max-width: 1400px) {
    ul#wp-admin-bar-root-default li:nth-of-type(1n+14) {display: none;}
    }
    @media screen and (max-width: 1350px) {
    ul#wp-admin-bar-root-default li:nth-of-type(1n+13) {display: none;}
    }';

}

$css_styles .= '@media screen and (max-width: 962px) {#adminmenu li.menu-top, #adminmenu li#collapse-menu{margin:0;}}';
