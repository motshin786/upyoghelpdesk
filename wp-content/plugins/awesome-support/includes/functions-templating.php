<?php
	...
	function wpas_ticket_header( $args = array() ) {
		...
		$columns = array(
			'id'     => __( 'Ticket ID', 'awesome-support' ),
			'status' => __( 'Ticket Status', 'awesome-support' ),
			'date'   => __( 'Created Date', 'awesome-support' ),
		);
...
.wpas-user-profile img{margin: 0 0px 0 -23px;}
</style>
        <table id="<?php echo esc_attr( $args[ 'table_id' ] ); ?>" class="<?php echo esc_attr( $args[ 'table_class' ] ); ?> myInput">
            <thead>
            <tr>
