...
<div style="width: 100%;float: left;font-weight: 700;font-size: 17px;">Ticket Number: <span style="font-size:14px; padding: 10px; font-weight:700; color:#FFF; background-color:#0066bf; border-radius:5px;">NUDM-<?php echo $post->ID ;?></span></div>
